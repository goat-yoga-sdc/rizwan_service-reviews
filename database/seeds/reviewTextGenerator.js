...
// word seeds
const opening = ['This product has a very', 'Just in case', 'It actually worked for', 'The reason why is that', 'Almost two days ago', 'I bought this for my girlfriend, and', 'I never thought', 'I expected to', 'Today I', 'Ask me how I', 'Completely', 'Nearly', 'The texture of this', 'Efficiently', 'Last night I', 'My friend', 'My sister', 'A nun told me to buy', 'A funny story', 'So, I bought this', 'I really can\'t', 'I got this to get rid of', 'I was very happy to', 'I can\'t believe', 'This ruined my', 'Never buy', 'Love this'];
...
const randomReviewSentence = (productName) => {
  ...
  let sentenceLength = getRandomIndex(6, 16);
  //start off with an opening phrase
  let newSentenceArr = [randomElement(opening)];
  ...
  newSentenceArr.splice(getRandomIndex(1, newSentenceArr.length), 0, productName);
  let reviewSentence = newSentenceArr.join(' ') + '.';
